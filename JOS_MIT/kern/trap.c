...
//	extern asmlinkage void sysenter_handler(void);
	...
	SETGATE(idt[T_NMI], 0, GD_KT, trap_ex_nmi, 0)
	SETGATE(idt[T_BRKPT], 0, GD_KT, trap_ex_break_point, 3)
	SETGATE(idt[T_OFLOW], 0, GD_KT, trap_ex_overflow, 0)
	SETGATE(idt[T_BOUND], 0, GD_KT, trap_ex_bound, 0)
	SETGATE(idt[T_ILLOP], 0, GD_KT, trap_ex_iop, 0)
	SETGATE(idt[T_DEVICE], 0, GD_KT, trap_ex_device, 0)
	SETGATE(idt[T_DBLFLT], 0, GD_KT, trap_ex_db_fault, 0)
	SETGATE(idt[T_TSS], 0, GD_KT, trap_ex_tss, 0)
	SETGATE(idt[T_SEGNP], 0, GD_KT, trap_ex_segnp, 0)
	SETGATE(idt[T_STACK], 0, GD_KT, trap_ex_stack, 0)
	SETGATE(idt[T_GPFLT], 0, GD_KT, trap_ex_gp_fault, 0)
	SETGATE(idt[T_PGFLT], 0, GD_KT, trap_ex_pg_fault, 0)
	SETGATE(idt[T_FPERR], 0, GD_KT, trap_ex_fp_error, 0)

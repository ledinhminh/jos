...
umain(int argc, char **argv)
{
  ...
  80004a:	e8 c8 03 00 00       	call   800417 <sys_cputs>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 fd 02 00 00       	call   800368 <sys_getenvid>
...
exit(void)
{
  ...
  8000a7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000aa:	e8 8a 08 00 00       	call   800939 <close_all>
	sys_env_destroy(0);
  8000af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b6:	e8 e8 02 00 00       	call   8003a3 <sys_env_destroy>
}
  8000bb:	c9                   	leave  
  8000bc:	c3                   	ret    
...
008000f0 <.after_sysenter_label>:
  ...
  80010b:	c7 44 24 08 18 1d 80 	movl   $0x801d18,0x8(%esp)
  800112:	00 
  800113:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  80011a:	00 
  80011b:	c7 04 24 35 1d 80 00 	movl   $0x801d35,(%esp)
  800122:	e8 19 0c 00 00       	call   800d40 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800163:	b8 0e 00 00 00       	mov    $0xe,%eax
  800168:	e8 53 ff ff ff       	call   8000c0 <syscall>
}
  80016d:	c9                   	leave  
  80016e:	c3                   	ret    
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800172:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_ipc_try_send, 0, envid, value, (uint32_t) srcva, perm, 0);
  800175:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80017c:	00 
  80017d:	8b 45 14             	mov    0x14(%ebp),%eax
  800180:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  800199:	b8 0d 00 00 00       	mov    $0xd,%eax
  80019e:	e8 1d ff ff ff       	call   8000c0 <syscall>
}
  8001a3:	c9                   	leave  
  8001a4:	c3                   	ret    

008001a5 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001d6:	e8 e5 fe ff ff       	call   8000c0 <syscall>
}
  8001db:	c9                   	leave  
  8001dc:	c3                   	ret    

008001dd <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80020e:	e8 ad fe ff ff       	call   8000c0 <syscall>
}
  800213:	c9                   	leave  
  800214:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80022a:	00 
  80022b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800232:	00 
  800233:	8b 45 0c             	mov    0xc(%ebp),%eax
  800236:	89 04 24             	mov    %eax,(%esp)
  800239:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80023c:	ba 01 00 00 00       	mov    $0x1,%edx
  800241:	b8 09 00 00 00       	mov    $0x9,%eax
  800246:	e8 75 fe ff ff       	call   8000c0 <syscall>
}
  80024b:	c9                   	leave  
  80024c:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80025a:	00 
  80025b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800262:	00 
  800263:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80026a:	00 
  ...
  800279:	b8 07 00 00 00       	mov    $0x7,%eax
  80027e:	e8 3d fe ff ff       	call   8000c0 <syscall>
}
  800283:	c9                   	leave  
  800284:	c3                   	ret    

00800285 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800292:	00 
  800293:	8b 45 18             	mov    0x18(%ebp),%eax
  800296:	0b 45 14             	or     0x14(%ebp),%eax
  ...
  8002b2:	b8 06 00 00 00       	mov    $0x6,%eax
  8002b7:	e8 04 fe ff ff       	call   8000c0 <syscall>
}
  8002bc:	c9                   	leave  
  8002bd:	c3                   	ret    

008002be <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002e9:	b8 05 00 00 00       	mov    $0x5,%eax
  8002ee:	e8 cd fd ff ff       	call   8000c0 <syscall>
}
  8002f3:	c9                   	leave  
  8002f4:	c3                   	ret    
...
sys_yield(void)
{
  ...
  800302:	00 
  800303:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80030a:	00 
  80030b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800312:	00 
  800313:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80031a:	b9 00 00 00 00       	mov    $0x0,%ecx
  80031f:	ba 00 00 00 00       	mov    $0x0,%edx
  800324:	b8 0c 00 00 00       	mov    $0xc,%eax
  800329:	e8 92 fd ff ff       	call   8000c0 <syscall>
}
  80032e:	c9                   	leave  
  80032f:	c3                   	ret    

00800330 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800333:	83 ec 18             	sub    $0x18,%esp
	 return syscall(SYS_map_kernel_page, 0, (uint32_t)kpage, (uint32_t)va, 0, 0, 0);
  800336:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80033d:	00 
  80033e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800345:	00 
  ...
  80035c:	b8 04 00 00 00       	mov    $0x4,%eax
  800361:	e8 5a fd ff ff       	call   8000c0 <syscall>
}
  800366:	c9                   	leave  
  800367:	c3                   	ret    

00800368 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  800397:	b8 02 00 00 00       	mov    $0x2,%eax
  80039c:	e8 1f fd ff ff       	call   8000c0 <syscall>
}
  8003a1:	c9                   	leave  
  8003a2:	c3                   	ret    

008003a3 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003c0:	00 
  8003c1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003c8:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8003cb:	ba 01 00 00 00       	mov    $0x1,%edx
  8003d0:	b8 03 00 00 00       	mov    $0x3,%eax
  8003d5:	e8 e6 fc ff ff       	call   8000c0 <syscall>
}
  8003da:	c9                   	leave  
  8003db:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8003e9:	00 
  8003ea:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003f1:	00 
  8003f2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003f9:	00 
  8003fa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800401:	b9 00 00 00 00       	mov    $0x0,%ecx
  800406:	ba 00 00 00 00       	mov    $0x0,%edx
  80040b:	b8 01 00 00 00       	mov    $0x1,%eax
  800410:	e8 ab fc ff ff       	call   8000c0 <syscall>
}
  800415:	c9                   	leave  
  800416:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800424:	00 
  800425:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80042c:	00 
  80042d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800434:	00 
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
		if (devtab[i]->dev_id == dev_id) {
  800574:	b8 08 30 80 00       	mov    $0x803008,%eax
  800579:	39 0d 08 30 80 00    	cmp    %ecx,0x803008
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800592:	be c0 1d 80 00       	mov    $0x801dc0,%esi
  ...
  8005b1:	c7 04 24 44 1d 80 00 	movl   $0x801d44,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800696:	c7 04 24 64 1d 80 00 	movl   $0x801d64,(%esp)
  ...
  8006f6:	e8 66 fe ff ff       	call   800561 <dev_lookup>
{
  ...
  800718:	c7 04 24 85 1d 80 00 	movl   $0x801d85,(%esp)
  ...
  80077f:	e8 dd fd ff ff       	call   800561 <dev_lookup>
{
  ...
  8007a6:	c7 04 24 a2 1d 80 00 	movl   $0x801da2,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8008ab:	e8 9d f9 ff ff       	call   80024d <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8009fc:	e8 84 f8 ff ff       	call   800285 <sys_page_map>
  ...
  800a37:	e8 49 f8 ff ff       	call   800285 <sys_page_map>
...
out:
  ...
  800d0d:	c7 44 24 0c c8 1d 80 	movl   $0x801dc8,0xc(%esp)
  800d14:	00 
  800d15:	c7 44 24 08 dd 1d 80 	movl   $0x801ddd,0x8(%esp)
  800d1c:	00 
  800d1d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800d24:	00 
  800d25:	c7 04 24 f2 1d 80 00 	movl   $0x801df2,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800d4b:	8b 1d 04 30 80 00    	mov    0x803004,%ebx
  800d51:	e8 12 f6 ff ff       	call   800368 <sys_getenvid>
  ...
  800d6c:	c7 04 24 00 1e 80 00 	movl   $0x801e00,(%esp)
  ...
  800d82:	e8 11 00 00 00       	call   800d98 <vcprintf>
	cprintf("\n");
  800d87:	c7 04 24 0c 1d 80 00 	movl   $0x801d0c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800dec:	e8 26 f6 ff ff       	call   800417 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800e40:	e8 d2 f5 ff ff       	call   800417 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800f41:	0f be 80 23 1e 80 00 	movsbl 0x801e23(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801107:	c7 44 24 08 34 1e 80 	movl   $0x801e34,0x8(%esp)
  80110e:	00 
  ...
  801161:	b8 3d 1e 80 00       	mov    $0x801e3d,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  8013a5:	c7 44 24 0c 58 1f 80 	movl   $0x801f58,0xc(%esp)
  8013ac:	00 
  8013ad:	c7 44 24 08 ef 1d 80 	movl   $0x801def,0x8(%esp)
  8013b4:	00 
  ...
  8013d3:	c7 44 24 0c 90 1f 80 	movl   $0x801f90,0xc(%esp)
  8013da:	00 
  8013db:	c7 44 24 08 ef 1d 80 	movl   $0x801def,0x8(%esp)
  8013e2:	00 
  ...
  8019b6:	e8 85 f3 ff ff       	call   800d40 <_panic>
{
  ...
  8019cd:	e8 9d e7 ff ff       	call   80016f <sys_ipc_try_send>
  ...
  8019d4:	75 bc                	jne    801992 <ipc_send+0x1e>
	...
	sys_yield();
  8019d6:	e8 1a e9 ff ff       	call   8002f5 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a08:	e8 29 e7 ff ff       	call   800136 <sys_ipc_recv>

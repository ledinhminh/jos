...
008000f0 <.after_sysenter_label>:
  ...
  80010b:	c7 44 24 08 d8 22 80 	movl   $0x8022d8,0x8(%esp)
  800112:	00 
  800113:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  80011a:	00 
  80011b:	c7 04 24 f5 22 80 00 	movl   $0x8022f5,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800612:	be 80 23 80 00       	mov    $0x802380,%esi
  ...
  800631:	c7 04 24 04 23 80 00 	movl   $0x802304,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800716:	c7 04 24 24 23 80 00 	movl   $0x802324,(%esp)
  ...
  800776:	e8 66 fe ff ff       	call   8005e1 <dev_lookup>
{
  ...
  800798:	c7 04 24 45 23 80 00 	movl   $0x802345,(%esp)
  ...
  8007ff:	e8 dd fd ff ff       	call   8005e1 <dev_lookup>
{
  ...
  800826:	c7 04 24 62 23 80 00 	movl   $0x802362,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800b3e:	e8 b6 13 00 00       	call   801ef9 <ipc_send>
  ...
  800b56:	e8 09 14 00 00       	call   801f64 <ipc_recv>
}
...
out:
  ...
  800d8d:	c7 44 24 0c 8c 23 80 	movl   $0x80238c,0xc(%esp)
  800d94:	00 
  800d95:	c7 44 24 08 a1 23 80 	movl   $0x8023a1,0x8(%esp)
  800d9c:	00 
  800d9d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800da4:	00 
  800da5:	c7 04 24 b6 23 80 00 	movl   $0x8023b6,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800dc6:	c7 44 24 04 c1 23 80 	movl   $0x8023c1,0x4(%esp)
  800dcd:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  800ded:	e8 02 12 00 00       	call   801ff4 <pageref>
...
nsipc(unsigned type)
{
  ...
  80104f:	e8 a5 0e 00 00       	call   801ef9 <ipc_send>
  ...
  80106b:	e8 f4 0e 00 00       	call   801f64 <ipc_recv>
}
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801118:	c7 44 24 0c cd 23 80 	movl   $0x8023cd,0xc(%esp)
  80111f:	00 
  801120:	c7 44 24 08 a1 23 80 	movl   $0x8023a1,0x8(%esp)
  801127:	00 
  801128:	c7 44 24 04 6c 00 00 	movl   $0x6c,0x4(%esp)
  80112f:	00 
  801130:	c7 04 24 d9 23 80 00 	movl   $0x8023d9,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8011ad:	c7 44 24 0c e5 23 80 	movl   $0x8023e5,0xc(%esp)
  8011b4:	00 
  8011b5:	c7 44 24 08 a1 23 80 	movl   $0x8023a1,0x8(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  8011c4:	00 
  8011c5:	c7 04 24 d9 23 80 00 	movl   $0x8023d9,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8012f0:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
  ...
  801306:	e8 11 00 00 00       	call   80131c <vcprintf>
	cprintf("\n");
  80130b:	c7 04 24 cc 22 80 00 	movl   $0x8022cc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80145d:	e8 de 0b 00 00       	call   802040 <__udivdi3>
  ...
  8014b8:	e8 b3 0c 00 00       	call   802170 <__umoddi3>
  8014bd:	89 74 24 04          	mov    %esi,0x4(%esp)
  8014c1:	0f be 80 1f 24 80 00 	movsbl 0x80241f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8015a5:	ff 24 95 00 26 80 00 	jmp    *0x802600(,%edx,4)
  ...
  8016a7:	c7 44 24 08 b3 23 80 	movl   $0x8023b3,0x8(%esp)
  8016ae:	00 
  ...
  8016e1:	b8 39 24 80 00       	mov    $0x802439,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  801925:	c7 44 24 0c 54 25 80 	movl   $0x802554,0xc(%esp)
  80192c:	00 
  80192d:	c7 44 24 08 b3 23 80 	movl   $0x8023b3,0x8(%esp)
  801934:	00 
  ...
  801953:	c7 44 24 0c 8c 25 80 	movl   $0x80258c,0xc(%esp)
  80195a:	00 
  80195b:	c7 44 24 08 b3 23 80 	movl   $0x8023b3,0x8(%esp)
  801962:	00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f20:	c7 44 24 08 a0 27 80 	movl   $0x8027a0,0x8(%esp)
  801f27:	00 
  801f28:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  801f2f:	00 
  801f30:	c7 04 24 be 27 80 00 	movl   $0x8027be,(%esp)
  801f37:	e8 88 f3 ff ff       	call   8012c4 <_panic>
{
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  801f4e:	e8 8f e2 ff ff       	call   8001e2 <sys_ipc_try_send>
  ...
  801f55:	75 c0                	jne    801f17 <ipc_send+0x1e>
	...
	sys_yield();
  801f57:	e8 0c e4 ff ff       	call   800368 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f89:	e8 1b e2 ff ff       	call   8001a9 <sys_ipc_recv>
  ...
  801f9c:	c7 04 24 c8 27 80 00 	movl   $0x8027c8,(%esp)
  801fa3:	e8 d5 f3 ff ff       	call   80137d <cprintf>

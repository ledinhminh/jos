	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fd:	e8 2e 1e 00 00       	call   802030 <__udivdi3>
  ...
  800258:	e8 03 1f 00 00       	call   802160 <__umoddi3>
  80025d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800261:	0f be 80 c8 22 80 00 	movsbl 0x8022c8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800427:	c7 44 24 08 d9 22 80 	movl   $0x8022d9,0x8(%esp)
  80042e:	00 
  ...
  800481:	b8 e2 22 80 00       	mov    $0x8022e2,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  8006c5:	c7 44 24 0c fc 23 80 	movl   $0x8023fc,0xc(%esp)
  8006cc:	00 
  ...
  8006f3:	c7 44 24 0c 34 24 80 	movl   $0x802434,0xc(%esp)
  8006fa:	00 
...
fsipc(unsigned type, void *dstva)
{
  ...
  8016be:	e8 26 08 00 00       	call   801ee9 <ipc_send>
  ...
  8016d6:	e8 79 08 00 00       	call   801f54 <ipc_recv>
}
...
devsock_close(struct Fd *fd)
{
  ...
  80196d:	e8 72 06 00 00       	call   801fe4 <pageref>
...
nsipc(unsigned type)
{
  ...
  801bcf:	e8 15 03 00 00       	call   801ee9 <ipc_send>
  ...
  801beb:	e8 64 03 00 00       	call   801f54 <ipc_recv>
}
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801e86:	e8 35 e2 ff ff       	call   8000c0 <vcprintf>
	cprintf("\n");
  801e8b:	c7 04 24 bc 22 80 00 	movl   $0x8022bc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f10:	c7 44 24 08 88 27 80 	movl   $0x802788,0x8(%esp)
  801f17:	00 
  801f18:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  801f1f:	00 
  801f20:	c7 04 24 a6 27 80 00 	movl   $0x8027a6,(%esp)
  801f27:	e8 18 ff ff ff       	call   801e44 <_panic>
{
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  801f3e:	e8 2b ee ff ff       	call   800d6e <sys_ipc_try_send>
  ...
  801f45:	75 c0                	jne    801f07 <ipc_send+0x1e>
	...
	sys_yield();
  801f47:	e8 a8 ef ff ff       	call   800ef4 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f79:	e8 b7 ed ff ff       	call   800d35 <sys_ipc_recv>
  ...
  801f8c:	c7 04 24 b0 27 80 00 	movl   $0x8027b0,(%esp)
  801f93:	e8 89 e1 ff ff       	call   800121 <cprintf>

...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 70 03 00 00       	call   8003cb <sys_getenvid>
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 0a 09 00 00       	call   8009a9 <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 5b 03 00 00       	call   800406 <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000d8:	8d 35 e0 00 80 00    	lea    0x8000e0,%esi
  8000de:	0f 34                	sysenter 

008000e0 <.after_sysenter_label>:
  8000e0:	5f                   	pop    %edi
  8000e1:	5e                   	pop    %esi
  8000e2:	5d                   	pop    %ebp
  8000e3:	5c                   	pop    %esp
  ...
  8000e7:	89 c2                	mov    %eax,%edx
	...
	if(check && ret > 0)
  8000e9:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8000ed:	74 28                	je     800117 <.after_sysenter_label+0x37>
  8000ef:	85 c0                	test   %eax,%eax
  8000f1:	7e 24                	jle    800117 <.after_sysenter_label+0x37>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000f3:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000f7:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8000fb:	c7 44 24 08 aa 22 80 	movl   $0x8022aa,0x8(%esp)
  800102:	00 
  800103:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  80010a:	00 
  80010b:	c7 04 24 c7 22 80 00 	movl   $0x8022c7,(%esp)
  800112:	e8 9d 11 00 00       	call   8012b4 <_panic>

	return ret;
}
  800117:	89 d0                	mov    %edx,%eax
  800119:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80011c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80011f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800122:	89 ec                	mov    %ebp,%esp
  800124:	5d                   	pop    %ebp
  800125:	c3                   	ret    

00800126 <sys_net_try_send>:
...
sys_net_try_send(void *data, size_t len)
{
  ...
  800152:	b8 10 00 00 00       	mov    $0x10,%eax
  800157:	e8 54 ff ff ff       	call   8000b0 <syscall>
}
  80015c:	c9                   	leave  
  80015d:	c3                   	ret    

0080015e <sys_time_msec>:
...
sys_time_msec(void)
{
  ...
  800192:	e8 19 ff ff ff       	call   8000b0 <syscall>
}
  800197:	c9                   	leave  
  800198:	c3                   	ret    

00800199 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  80019c:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_ipc_recv, 1, (uint32_t)dstva, 0, 0, 0, 0);
  80019f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8001a6:	00 
  8001a7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8001ae:	00 
  8001af:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001b6:	00 
  8001b7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001be:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8001c1:	ba 01 00 00 00       	mov    $0x1,%edx
  8001c6:	b8 0e 00 00 00       	mov    $0xe,%eax
  8001cb:	e8 e0 fe ff ff       	call   8000b0 <syscall>
}
  8001d0:	c9                   	leave  
  8001d1:	c3                   	ret    

008001d2 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001fc:	b8 0d 00 00 00       	mov    $0xd,%eax
  800201:	e8 aa fe ff ff       	call   8000b0 <syscall>
}
  800206:	c9                   	leave  
  800207:	c3                   	ret    

00800208 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80020b:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_env_set_pgfault_upcall, 1, envid, (uint32_t) upcall, 0, 0, 0);
  80020e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800215:	00 
  ...
  800234:	b8 0b 00 00 00       	mov    $0xb,%eax
  800239:	e8 72 fe ff ff       	call   8000b0 <syscall>
}
  80023e:	c9                   	leave  
  80023f:	c3                   	ret    
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80025d:	00 
  ...
  800271:	e8 3a fe ff ff       	call   8000b0 <syscall>
}
  800276:	c9                   	leave  
  800277:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800285:	00 
  800286:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80028d:	00 
  80028e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800295:	00 
  ...
  8002a9:	e8 02 fe ff ff       	call   8000b0 <syscall>
}
  8002ae:	c9                   	leave  
  8002af:	c3                   	ret    

008002b0 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002bd:	00 
  8002be:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8002cd:	00 
  8002ce:	8b 45 0c             	mov    0xc(%ebp),%eax
  8002d1:	89 04 24             	mov    %eax,(%esp)
  8002d4:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8002d7:	ba 01 00 00 00       	mov    $0x1,%edx
  8002dc:	b8 07 00 00 00       	mov    $0x7,%eax
  8002e1:	e8 ca fd ff ff       	call   8000b0 <syscall>
}
  8002e6:	c9                   	leave  
  8002e7:	c3                   	ret    

008002e8 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002f9:	0b 45 14             	or     0x14(%ebp),%eax
  ...
  800310:	ba 01 00 00 00       	mov    $0x1,%edx
  800315:	b8 06 00 00 00       	mov    $0x6,%eax
  80031a:	e8 91 fd ff ff       	call   8000b0 <syscall>
}
  80031f:	c9                   	leave  
  800320:	c3                   	ret    

00800321 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80032e:	00 
  80032f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800336:	00 
  ...
  800347:	ba 01 00 00 00       	mov    $0x1,%edx
  80034c:	b8 05 00 00 00       	mov    $0x5,%eax
  800351:	e8 5a fd ff ff       	call   8000b0 <syscall>
}
  800356:	c9                   	leave  
  800357:	c3                   	ret    
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800396:	83 ec 18             	sub    $0x18,%esp
	 return syscall(SYS_map_kernel_page, 0, (uint32_t)kpage, (uint32_t)va, 0, 0, 0);
  800399:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8003a0:	00 
  8003a1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003a8:	00 
  8003a9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003b0:	00 
  8003b1:	8b 45 0c             	mov    0xc(%ebp),%eax
  8003b4:	89 04 24             	mov    %eax,(%esp)
  8003b7:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8003ba:	ba 00 00 00 00       	mov    $0x0,%edx
  8003bf:	b8 04 00 00 00       	mov    $0x4,%eax
  8003c4:	e8 e7 fc ff ff       	call   8000b0 <syscall>
}
  8003c9:	c9                   	leave  
  8003ca:	c3                   	ret    

008003cb <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003ce:	83 ec 18             	sub    $0x18,%esp
	 return syscall(SYS_getenvid, 0, 0, 0, 0, 0, 0);
  8003d1:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8003d8:	00 
  8003d9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003e0:	00 
  8003e1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003e8:	00 
  8003e9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003f0:	b9 00 00 00 00       	mov    $0x0,%ecx
  8003f5:	ba 00 00 00 00       	mov    $0x0,%edx
  8003fa:	b8 02 00 00 00       	mov    $0x2,%eax
  8003ff:	e8 ac fc ff ff       	call   8000b0 <syscall>
}
  800404:	c9                   	leave  
  800405:	c3                   	ret    

00800406 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  800413:	00 
  800414:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80041b:	00 
  80041c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800423:	00 
  800424:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80042b:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80042e:	ba 01 00 00 00       	mov    $0x1,%edx
  800433:	b8 03 00 00 00       	mov    $0x3,%eax
  800438:	e8 73 fc ff ff       	call   8000b0 <syscall>
}
  80043d:	c9                   	leave  
  80043e:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  80044c:	00 
  80044d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800454:	00 
  ...
  800473:	e8 38 fc ff ff       	call   8000b0 <syscall>
}
  800478:	c9                   	leave  
  800479:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8004ab:	e8 00 fc ff ff       	call   8000b0 <syscall>
}
  8004b0:	c9                   	leave  
  8004b1:	c3                   	ret    
	...
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  80091b:	e8 90 f9 ff ff       	call   8002b0 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800a6c:	e8 77 f8 ff ff       	call   8002e8 <sys_page_map>
  ...
  800aa7:	e8 3c f8 ff ff       	call   8002e8 <sys_page_map>
...
alloc_sockfd(int sockid)
{
  ...
  800e88:	e8 94 f4 ff ff       	call   800321 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8012c5:	e8 01 f1 ff ff       	call   8003cb <sys_getenvid>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801360:	e8 15 f1 ff ff       	call   80047a <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  8013b4:	e8 c1 f0 ff ff       	call   80047a <sys_cputs>
		b->idx = 0;
  ...
  801f22:	e8 8d f3 ff ff       	call   8012b4 <_panic>
{
  ...
  801f39:	e8 94 e2 ff ff       	call   8001d2 <sys_ipc_try_send>
  ...
  801f40:	75 c0                	jne    801f02 <ipc_send+0x1e>
	...
	sys_yield();
  801f42:	e8 11 e4 ff ff       	call   800358 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f74:	e8 20 e2 ff ff       	call   800199 <sys_ipc_recv>

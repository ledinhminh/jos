...
umain(int argc, char **argv)
{
  ...
  800049:	e8 5f 01 00 00       	call   8001ad <sys_env_set_pgfault_upcall>
	*(int*)0 = 0;
...
libmain(int argc, char **argv)
{
  ...
  80006e:	e8 fd 02 00 00       	call   800370 <sys_getenvid>
...
exit(void)
{
  ...
  8000af:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b2:	e8 b2 08 00 00       	call   800969 <close_all>
	sys_env_destroy(0);
  8000b7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000be:	e8 e8 02 00 00       	call   8003ab <sys_env_destroy>
}
  8000c3:	c9                   	leave  
  8000c4:	c3                   	ret    
...
008000f8 <.after_sysenter_label>:
  ...
  800113:	c7 44 24 08 aa 1d 80 	movl   $0x801daa,0x8(%esp)
  80011a:	00 
  80011b:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800122:	00 
  800123:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  80012a:	e8 41 0c 00 00       	call   800d70 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80016b:	b8 0e 00 00 00       	mov    $0xe,%eax
  800170:	e8 53 ff ff ff       	call   8000c8 <syscall>
}
  800175:	c9                   	leave  
  800176:	c3                   	ret    

00800177 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001a1:	b8 0d 00 00 00       	mov    $0xd,%eax
  8001a6:	e8 1d ff ff ff       	call   8000c8 <syscall>
}
  8001ab:	c9                   	leave  
  8001ac:	c3                   	ret    

008001ad <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001c2:	00 
  8001c3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001ca:	00 
  ...
  8001de:	e8 e5 fe ff ff       	call   8000c8 <syscall>
}
  8001e3:	c9                   	leave  
  8001e4:	c3                   	ret    
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800211:	b8 0a 00 00 00       	mov    $0xa,%eax
  800216:	e8 ad fe ff ff       	call   8000c8 <syscall>
}
  80021b:	c9                   	leave  
  80021c:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80022a:	00 
  80022b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800232:	00 
  800233:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80023a:	00 
  80023b:	8b 45 0c             	mov    0xc(%ebp),%eax
  80023e:	89 04 24             	mov    %eax,(%esp)
  800241:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800244:	ba 01 00 00 00       	mov    $0x1,%edx
  800249:	b8 09 00 00 00       	mov    $0x9,%eax
  80024e:	e8 75 fe ff ff       	call   8000c8 <syscall>
}
  800253:	c9                   	leave  
  800254:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800262:	00 
  800263:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80026a:	00 
  80026b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800272:	00 
  800273:	8b 45 0c             	mov    0xc(%ebp),%eax
  800276:	89 04 24             	mov    %eax,(%esp)
  800279:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80027c:	ba 01 00 00 00       	mov    $0x1,%edx
  800281:	b8 07 00 00 00       	mov    $0x7,%eax
  800286:	e8 3d fe ff ff       	call   8000c8 <syscall>
}
  80028b:	c9                   	leave  
  80028c:	c3                   	ret    

0080028d <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80029a:	00 
  80029b:	8b 45 18             	mov    0x18(%ebp),%eax
  80029e:	0b 45 14             	or     0x14(%ebp),%eax
  ...
  8002bf:	e8 04 fe ff ff       	call   8000c8 <syscall>
}
  8002c4:	c9                   	leave  
  8002c5:	c3                   	ret    

008002c6 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002d3:	00 
  8002d4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002db:	00 
  ...
  8002ec:	ba 01 00 00 00       	mov    $0x1,%edx
  8002f1:	b8 05 00 00 00       	mov    $0x5,%eax
  8002f6:	e8 cd fd ff ff       	call   8000c8 <syscall>
}
  8002fb:	c9                   	leave  
  8002fc:	c3                   	ret    
...
sys_yield(void)
{
  ...
  80030a:	00 
  80030b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800312:	00 
  800313:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80031a:	00 
  ...
  800331:	e8 92 fd ff ff       	call   8000c8 <syscall>
}
  800336:	c9                   	leave  
  800337:	c3                   	ret    

00800338 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800345:	00 
  800346:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80034d:	00 
  80034e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800355:	00 
  ...
  800364:	b8 04 00 00 00       	mov    $0x4,%eax
  800369:	e8 5a fd ff ff       	call   8000c8 <syscall>
}
  80036e:	c9                   	leave  
  80036f:	c3                   	ret    

00800370 <sys_getenvid>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003c8:	00 
  8003c9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003d0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8003d3:	ba 01 00 00 00       	mov    $0x1,%edx
  8003d8:	b8 03 00 00 00       	mov    $0x3,%eax
  8003dd:	e8 e6 fc ff ff       	call   8000c8 <syscall>
}
  8003e2:	c9                   	leave  
  8003e3:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8003f1:	00 
  8003f2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003f9:	00 
  8003fa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800401:	00 
  800402:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800409:	b9 00 00 00 00       	mov    $0x0,%ecx
  80040e:	ba 00 00 00 00       	mov    $0x0,%edx
  800413:	b8 01 00 00 00       	mov    $0x1,%eax
  800418:	e8 ab fc ff ff       	call   8000c8 <syscall>
}
  80041d:	c9                   	leave  
  80041e:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800422:	83 ec 18             	sub    $0x18,%esp
	syscall(SYS_cputs, 0, (uint32_t)s, len, 0, 0, 0);
  800425:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80042c:	00 
  80042d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800434:	00 
  800435:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80043c:	00 
...
_pgfault_upcall:
  ...
  800459:	a1 00 60 80 00       	mov    0x806000,%eax
	call *%eax
  ...
  800460:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x30(%esp), %eax
  800463:	8b 44 24 30          	mov    0x30(%esp),%eax
	subl $0x4, %eax
  800467:	83 e8 04             	sub    $0x4,%eax
	movl %eax, 0x30(%esp)
  80046a:	89 44 24 30          	mov    %eax,0x30(%esp)
	# put old eip in the pre-reserved 4 bytes space
	movl 0x28(%esp), %ebx
  80046e:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl %ebx, (%eax)
  800472:	89 18                	mov    %ebx,(%eax)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8005c2:	be 54 1e 80 00       	mov    $0x801e54,%esi
  ...
  8005e1:	c7 04 24 d8 1d 80 00 	movl   $0x801dd8,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8006c6:	c7 04 24 f8 1d 80 00 	movl   $0x801df8,(%esp)
  ...
  800726:	e8 66 fe ff ff       	call   800591 <dev_lookup>
{
  ...
  800748:	c7 04 24 19 1e 80 00 	movl   $0x801e19,(%esp)
  ...
  8007af:	e8 dd fd ff ff       	call   800591 <dev_lookup>
{
  ...
  8007d6:	c7 04 24 36 1e 80 00 	movl   $0x801e36,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8008db:	e8 75 f9 ff ff       	call   800255 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800a2c:	e8 5c f8 ff ff       	call   80028d <sys_page_map>
  ...
  800a67:	e8 21 f8 ff ff       	call   80028d <sys_page_map>
...
fsipc(unsigned type, void *dstva)
{
  ...
  800ac8:	e8 03 0f 00 00       	call   8019d0 <ipc_find_env>
  ...
  800aee:	e8 21 0f 00 00       	call   801a14 <ipc_send>
  ...
  800b06:	e8 78 0f 00 00       	call   801a83 <ipc_recv>
}
...
out:
  ...
  800d3d:	c7 44 24 0c 5c 1e 80 	movl   $0x801e5c,0xc(%esp)
  800d44:	00 
  800d45:	c7 44 24 08 71 1e 80 	movl   $0x801e71,0x8(%esp)
  800d4c:	00 
  800d4d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800d54:	00 
  800d55:	c7 04 24 86 1e 80 00 	movl   $0x801e86,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800d81:	e8 ea f5 ff ff       	call   800370 <sys_getenvid>
  ...
  800d9c:	c7 04 24 94 1e 80 00 	movl   $0x801e94,(%esp)
  ...
  800db2:	e8 11 00 00 00       	call   800dc8 <vcprintf>
	cprintf("\n");
  800db7:	c7 04 24 50 1e 80 00 	movl   $0x801e50,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800e1c:	e8 fe f5 ff ff       	call   80041f <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800e70:	e8 aa f5 ff ff       	call   80041f <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800f0d:	e8 0e 0c 00 00       	call   801b20 <__udivdi3>
  ...
  800f68:	e8 e3 0c 00 00       	call   801c50 <__umoddi3>
  800f6d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f71:	0f be 80 b7 1e 80 00 	movsbl 0x801eb7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801055:	ff 24 95 a0 20 80 00 	jmp    *0x8020a0(,%edx,4)
  ...
  801157:	c7 44 24 08 83 1e 80 	movl   $0x801e83,0x8(%esp)
  80115e:	00 
  ...
  801191:	b8 d1 1e 80 00       	mov    $0x801ed1,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  8013d5:	c7 44 24 0c ec 1f 80 	movl   $0x801fec,0xc(%esp)
  8013dc:	00 
  8013dd:	c7 44 24 08 83 1e 80 	movl   $0x801e83,0x8(%esp)
  8013e4:	00 
  ...
  801403:	c7 44 24 0c 24 20 80 	movl   $0x802024,0xc(%esp)
  80140a:	00 
  80140b:	c7 44 24 08 83 1e 80 	movl   $0x801e83,0x8(%esp)
  801412:	00 
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801962:	83 3d 00 60 80 00 00 	cmpl   $0x0,0x806000
  801969:	75 54                	jne    8019bf <set_pgfault_handler+0x63>
		// First time through!
		// LAB 4: Your code here.
  ...
  801982:	e8 3f e9 ff ff       	call   8002c6 <sys_page_alloc>
  801987:	85 c0                	test   %eax,%eax
  801989:	79 20                	jns    8019ab <set_pgfault_handler+0x4f>
			panic ("set_pgfault_handler: %e", r);
  80198b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80198f:	c7 44 24 08 40 22 80 	movl   $0x802240,0x8(%esp)
  801996:	00 
  801997:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  80199e:	00 
  80199f:	c7 04 24 58 22 80 00 	movl   $0x802258,(%esp)
  8019a6:	e8 c5 f3 ff ff       	call   800d70 <_panic>
		sys_env_set_pgfault_upcall (0, _pgfault_upcall);
  8019ab:	c7 44 24 04 58 04 80 	movl   $0x800458,0x4(%esp)
  8019b2:	00 
  8019b3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8019ba:	e8 ee e7 ff ff       	call   8001ad <sys_env_set_pgfault_upcall>
...
ipc_find_env(enum EnvType type)
{
  ...
  8019d6:	8b 15 50 00 c0 ee    	mov    0xeec00050,%edx
  8019dc:	b8 01 00 00 00       	mov    $0x1,%eax
  8019e1:	39 ca                	cmp    %ecx,%edx
  8019e3:	75 04                	jne    8019e9 <ipc_find_env+0x19>
  8019e5:	b0 00                	mov    $0x0,%al
  8019e7:	eb 0f                	jmp    8019f8 <ipc_find_env+0x28>
  8019e9:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8019ec:	81 c2 50 00 c0 ee    	add    $0xeec00050,%edx
  8019f2:	8b 12                	mov    (%edx),%edx
  8019f4:	39 ca                	cmp    %ecx,%edx
  8019f6:	75 0c                	jne    801a04 <ipc_find_env+0x34>
			return envs[i].env_id;
  8019f8:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8019fb:	05 48 00 c0 ee       	add    $0xeec00048,%eax
  801a00:	8b 00                	mov    (%eax),%eax
  801a02:	eb 0e                	jmp    801a12 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801a07:	3d 00 04 00 00       	cmp    $0x400,%eax
  801a0c:	75 db                	jne    8019e9 <ipc_find_env+0x19>
  801a0e:	66 b8 00 00          	mov    $0x0,%ax
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a20:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  801a30:	eb 29                	jmp    801a5b <ipc_send+0x47>
		pg = (void*)UTOP; 
	while((r = sys_ipc_try_send(to_env,val,pg,perm)) != 0)
	{
		if( r < 0 && r != -E_IPC_NOT_RECV )
  801a32:	85 c0                	test   %eax,%eax
  801a34:	79 25                	jns    801a5b <ipc_send+0x47>
  801a36:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801a39:	74 20                	je     801a5b <ipc_send+0x47>
			panic ("ipc: sys try send failed : %e", r);
  801a3b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801a3f:	c7 44 24 08 66 22 80 	movl   $0x802266,0x8(%esp)
  801a46:	00 
  801a47:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  801a4e:	00 
  801a4f:	c7 04 24 84 22 80 00 	movl   $0x802284,(%esp)
  801a56:	e8 15 f3 ff ff       	call   800d70 <_panic>
{
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  801a6d:	e8 05 e7 ff ff       	call   800177 <sys_ipc_try_send>
  801a72:	85 c0                	test   %eax,%eax
  801a74:	75 bc                	jne    801a32 <ipc_send+0x1e>
	{
		if( r < 0 && r != -E_IPC_NOT_RECV )
			panic ("ipc: sys try send failed : %e", r);
	}
	sys_yield();
  801a76:	e8 82 e8 ff ff       	call   8002fd <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a89:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  801a8c:	89 75 f8             	mov    %esi,-0x8(%ebp)
  801a8f:	89 7d fc             	mov    %edi,-0x4(%ebp)
  801a92:	8b 75 08             	mov    0x8(%ebp),%esi
  801a95:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a98:	8b 7d 10             	mov    0x10(%ebp),%edi
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  801aa8:	e8 91 e6 ff ff       	call   80013e <sys_ipc_recv>
  801aad:	89 c3                	mov    %eax,%ebx
  801aaf:	85 c0                	test   %eax,%eax
  801ab1:	79 2a                	jns    801add <ipc_recv+0x5a>
	{
		cprintf("recv wrong %e %x\n",r,r);
  801ab3:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ab7:	89 44 24 04          	mov    %eax,0x4(%esp)
  801abb:	c7 04 24 8e 22 80 00 	movl   $0x80228e,(%esp)
  801ac2:	e8 62 f3 ff ff       	call   800e29 <cprintf>
		if(from_env_store != NULL)
  801ac7:	85 f6                	test   %esi,%esi
  801ac9:	74 06                	je     801ad1 <ipc_recv+0x4e>
			*from_env_store = 0;
  801acb:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store != NULL)
  801ad1:	85 ff                	test   %edi,%edi
  801ad3:	74 2d                	je     801b02 <ipc_recv+0x7f>
			*perm_store = 0;
  801ad5:	c7 07 00 00 00 00    	movl   $0x0,(%edi)
  801adb:	eb 25                	jmp    801b02 <ipc_recv+0x7f>
		return r;
	}
	if(from_env_store != NULL)
  801add:	85 f6                	test   %esi,%esi
  801adf:	90                   	nop
  801ae0:	74 0a                	je     801aec <ipc_recv+0x69>
		*from_env_store = thisenv->env_ipc_from;
  801ae2:	a1 04 40 80 00       	mov    0x804004,%eax
  801ae7:	8b 40 74             	mov    0x74(%eax),%eax
  801aea:	89 06                	mov    %eax,(%esi)
	if(perm_store != NULL)
  801aec:	85 ff                	test   %edi,%edi
  801aee:	74 0a                	je     801afa <ipc_recv+0x77>
		*perm_store = thisenv->env_ipc_perm;
  801af0:	a1 04 40 80 00       	mov    0x804004,%eax
  801af5:	8b 40 78             	mov    0x78(%eax),%eax
  801af8:	89 07                	mov    %eax,(%edi)
	//panic("ipc_recv not implemented");
	return thisenv->env_ipc_value;
  801afa:	a1 04 40 80 00       	mov    0x804004,%eax
  801aff:	8b 58 70             	mov    0x70(%eax),%ebx
}
  801b02:	89 d8                	mov    %ebx,%eax
  801b04:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  801b07:	8b 75 f8             	mov    -0x8(%ebp),%esi
  801b0a:	8b 7d fc             	mov    -0x4(%ebp),%edi
  801b0d:	89 ec                	mov    %ebp,%esp
  801b0f:	5d                   	pop    %ebp
  801b10:	c3                   	ret    
	...
...
00801b20 <__udivdi3>:
  ...
  801b36:	89 55 f0             	mov    %edx,-0x10(%ebp)
  801b39:	75 35                	jne    801b70 <__udivdi3+0x50>
  801b3b:	39 fe                	cmp    %edi,%esi
  801b3d:	77 61                	ja     801ba0 <__udivdi3+0x80>
  801b3f:	85 f6                	test   %esi,%esi
  801b41:	75 0b                	jne    801b4e <__udivdi3+0x2e>
  801b43:	b8 01 00 00 00       	mov    $0x1,%eax
  801b48:	31 d2                	xor    %edx,%edx
  801b4a:	f7 f6                	div    %esi
  801b4c:	89 c6                	mov    %eax,%esi
  801b4e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  801b51:	31 d2                	xor    %edx,%edx
  801b53:	89 f8                	mov    %edi,%eax
  801b55:	f7 f6                	div    %esi
  801b57:	89 c7                	mov    %eax,%edi
  801b59:	89 c8                	mov    %ecx,%eax
  801b5b:	f7 f6                	div    %esi
  ...
  801b70:	39 f8                	cmp    %edi,%eax
  801b72:	77 1c                	ja     801b90 <__udivdi3+0x70>
  801b74:	0f bd d0             	bsr    %eax,%edx
  801b77:	83 f2 1f             	xor    $0x1f,%edx
  801b7a:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801b7d:	75 39                	jne    801bb8 <__udivdi3+0x98>
  801b7f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
  801b82:	0f 86 a0 00 00 00    	jbe    801c28 <__udivdi3+0x108>
  801b88:	39 f8                	cmp    %edi,%eax
  801b8a:	0f 82 98 00 00 00    	jb     801c28 <__udivdi3+0x108>
  801b90:	31 ff                	xor    %edi,%edi
  801b92:	31 c9                	xor    %ecx,%ecx
  ...
  801ba6:	31 ff                	xor    %edi,%edi
  801ba8:	f7 f6                	div    %esi
  ...
  801bb6:	c3                   	ret    
  801bb7:	90                   	nop
  801bb8:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801bbc:	89 f2                	mov    %esi,%edx
  801bbe:	d3 e0                	shl    %cl,%eax
  801bc0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801bc3:	b8 20 00 00 00       	mov    $0x20,%eax
  801bc8:	2b 45 f4             	sub    -0xc(%ebp),%eax
  801bcb:	89 c1                	mov    %eax,%ecx
  801bcd:	d3 ea                	shr    %cl,%edx
  801bcf:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801bd3:	0b 55 ec             	or     -0x14(%ebp),%edx
  801bd6:	d3 e6                	shl    %cl,%esi
  801bd8:	89 c1                	mov    %eax,%ecx
  801bda:	89 75 e8             	mov    %esi,-0x18(%ebp)
  801bdd:	89 fe                	mov    %edi,%esi
  801bdf:	d3 ee                	shr    %cl,%esi
  801be1:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801be5:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801be8:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801beb:	d3 e7                	shl    %cl,%edi
  801bed:	89 c1                	mov    %eax,%ecx
  801bef:	d3 ea                	shr    %cl,%edx
  801bf1:	09 d7                	or     %edx,%edi
  ...
  801bfe:	f7 65 e8             	mull   -0x18(%ebp)
  801c01:	39 d6                	cmp    %edx,%esi
  801c03:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801c06:	72 30                	jb     801c38 <__udivdi3+0x118>
  801c08:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801c0b:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801c0f:	d3 e2                	shl    %cl,%edx
  801c11:	39 c2                	cmp    %eax,%edx
  801c13:	73 05                	jae    801c1a <__udivdi3+0xfa>
  801c15:	3b 75 ec             	cmp    -0x14(%ebp),%esi
  801c18:	74 1e                	je     801c38 <__udivdi3+0x118>
  801c1a:	89 f9                	mov    %edi,%ecx
  801c1c:	31 ff                	xor    %edi,%edi
  801c1e:	e9 71 ff ff ff       	jmp    801b94 <__udivdi3+0x74>
  801c23:	90                   	nop
  801c24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801c28:	31 ff                	xor    %edi,%edi
  801c2a:	b9 01 00 00 00       	mov    $0x1,%ecx
  801c2f:	e9 60 ff ff ff       	jmp    801b94 <__udivdi3+0x74>
  801c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801c38:	8d 4f ff             	lea    -0x1(%edi),%ecx
...
00801c50 <__umoddi3>:
  ...
  801c58:	8b 55 14             	mov    0x14(%ebp),%edx
  801c5b:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801c5e:	8b 7d 10             	mov    0x10(%ebp),%edi
  801c61:	8b 75 0c             	mov    0xc(%ebp),%esi
  801c64:	85 d2                	test   %edx,%edx
  801c66:	89 c8                	mov    %ecx,%eax
  801c68:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  801c6b:	75 13                	jne    801c80 <__umoddi3+0x30>
  801c6d:	39 f7                	cmp    %esi,%edi
  801c6f:	76 3f                	jbe    801cb0 <__umoddi3+0x60>
  ...
  801c82:	77 4c                	ja     801cd0 <__umoddi3+0x80>
  801c84:	0f bd ca             	bsr    %edx,%ecx
  801c87:	83 f1 1f             	xor    $0x1f,%ecx
  801c8a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  801c8d:	75 51                	jne    801ce0 <__umoddi3+0x90>
  801c8f:	3b 7d f4             	cmp    -0xc(%ebp),%edi
  801c92:	0f 87 e0 00 00 00    	ja     801d78 <__umoddi3+0x128>
  801c98:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c9b:	29 f8                	sub    %edi,%eax
  801c9d:	19 d6                	sbb    %edx,%esi
  ...
  801cb2:	75 0b                	jne    801cbf <__umoddi3+0x6f>
  801cb4:	b8 01 00 00 00       	mov    $0x1,%eax
  801cb9:	31 d2                	xor    %edx,%edx
  801cbb:	f7 f7                	div    %edi
  ...
  801ce0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801ce4:	d3 e2                	shl    %cl,%edx
  801ce6:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801ce9:	ba 20 00 00 00       	mov    $0x20,%edx
  801cee:	2b 55 f0             	sub    -0x10(%ebp),%edx
  801cf1:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801cf4:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801cf8:	89 fa                	mov    %edi,%edx
  801cfa:	d3 ea                	shr    %cl,%edx
  801cfc:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801d00:	0b 55 f4             	or     -0xc(%ebp),%edx
  801d03:	d3 e7                	shl    %cl,%edi
  801d05:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801d09:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801d0c:	89 f2                	mov    %esi,%edx
  801d0e:	89 7d e8             	mov    %edi,-0x18(%ebp)
  801d11:	89 c7                	mov    %eax,%edi
  801d13:	d3 ea                	shr    %cl,%edx
  801d15:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801d19:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  801d1c:	89 c2                	mov    %eax,%edx
  801d1e:	d3 e6                	shl    %cl,%esi
  801d20:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801d24:	d3 ea                	shr    %cl,%edx
  801d26:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801d2a:	09 d6                	or     %edx,%esi
  801d2c:	89 f0                	mov    %esi,%eax
  801d2e:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  801d31:	d3 e7                	shl    %cl,%edi
  801d33:	89 f2                	mov    %esi,%edx
  801d35:	f7 75 f4             	divl   -0xc(%ebp)
  801d38:	89 d6                	mov    %edx,%esi
  801d3a:	f7 65 e8             	mull   -0x18(%ebp)
  801d3d:	39 d6                	cmp    %edx,%esi
  801d3f:	72 2b                	jb     801d6c <__umoddi3+0x11c>
  801d41:	39 c7                	cmp    %eax,%edi
  801d43:	72 23                	jb     801d68 <__umoddi3+0x118>
  801d45:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801d49:	29 c7                	sub    %eax,%edi
  801d4b:	19 d6                	sbb    %edx,%esi
  801d4d:	89 f0                	mov    %esi,%eax
  801d4f:	89 f2                	mov    %esi,%edx
  801d51:	d3 ef                	shr    %cl,%edi
  801d53:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801d57:	d3 e0                	shl    %cl,%eax
  801d59:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801d5d:	09 f8                	or     %edi,%eax
  801d5f:	d3 ea                	shr    %cl,%edx
  801d61:	83 c4 20             	add    $0x20,%esp
  801d64:	5e                   	pop    %esi
  801d65:	5f                   	pop    %edi
  801d66:	5d                   	pop    %ebp
  801d67:	c3                   	ret    
  801d68:	39 d6                	cmp    %edx,%esi
  801d6a:	75 d9                	jne    801d45 <__umoddi3+0xf5>
  801d6c:	2b 45 e8             	sub    -0x18(%ebp),%eax
  801d6f:	1b 55 f4             	sbb    -0xc(%ebp),%edx
  801d72:	eb d1                	jmp    801d45 <__umoddi3+0xf5>
  801d74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801d78:	39 f2                	cmp    %esi,%edx
  801d7a:	0f 82 18 ff ff ff    	jb     801c98 <__umoddi3+0x48>
  801d80:	e9 1d ff ff ff       	jmp    801ca2 <__umoddi3+0x52>

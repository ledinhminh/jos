...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 a0 	movl   $0x8022a0,0x803000
  800041:	22 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 17 03 00 00       	call   800360 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 70 03 00 00       	call   8003d3 <sys_getenvid>
...
exit(void)
{
  ...
  80009f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a2:	e8 02 09 00 00       	call   8009a9 <close_all>
	sys_env_destroy(0);
  8000a7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000ae:	e8 5b 03 00 00       	call   80040e <sys_env_destroy>
}
  8000b3:	c9                   	leave  
  8000b4:	c3                   	ret    
...
008000e8 <.after_sysenter_label>:
  ...
  800103:	c7 44 24 08 af 22 80 	movl   $0x8022af,0x8(%esp)
  80010a:	00 
  80010b:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800112:	00 
  800113:	c7 04 24 cc 22 80 00 	movl   $0x8022cc,(%esp)
  80011a:	e8 95 11 00 00       	call   8012b4 <_panic>
...
sys_net_try_send(void *data, size_t len)
{
  ...
  80015a:	b8 10 00 00 00       	mov    $0x10,%eax
  80015f:	e8 54 ff ff ff       	call   8000b8 <syscall>
}
  800164:	c9                   	leave  
  800165:	c3                   	ret    

00800166 <sys_time_msec>:
...
sys_time_msec(void)
{
  ...
  800169:	83 ec 18             	sub    $0x18,%esp
	return (unsigned int) syscall(SYS_time_msec, 0, 0, 0, 0, 0, 0);
  80016c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800173:	00 
  800174:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80017b:	00 
  80017c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800183:	00 
  800184:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80018b:	b9 00 00 00 00       	mov    $0x0,%ecx
  800190:	ba 00 00 00 00       	mov    $0x0,%edx
  800195:	b8 0f 00 00 00       	mov    $0xf,%eax
  80019a:	e8 19 ff ff ff       	call   8000b8 <syscall>
}
  80019f:	c9                   	leave  
  8001a0:	c3                   	ret    

008001a1 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8001a4:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_ipc_recv, 1, (uint32_t)dstva, 0, 0, 0, 0);
  8001a7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8001ae:	00 
  8001af:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8001b6:	00 
  8001b7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001be:	00 
  8001bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001c6:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8001c9:	ba 01 00 00 00       	mov    $0x1,%edx
  8001ce:	b8 0e 00 00 00       	mov    $0xe,%eax
  8001d3:	e8 e0 fe ff ff       	call   8000b8 <syscall>
}
  8001d8:	c9                   	leave  
  8001d9:	c3                   	ret    

008001da <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800204:	b8 0d 00 00 00       	mov    $0xd,%eax
  800209:	e8 aa fe ff ff       	call   8000b8 <syscall>
}
  80020e:	c9                   	leave  
  80020f:	c3                   	ret    
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80021d:	00 
  80021e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800225:	00 
  800226:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80022d:	00 
  ...
  80023c:	b8 0b 00 00 00       	mov    $0xb,%eax
  800241:	e8 72 fe ff ff       	call   8000b8 <syscall>
}
  800246:	c9                   	leave  
  800247:	c3                   	ret    
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800255:	00 
  800256:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80025d:	00 
  80025e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800265:	00 
  ...
  800274:	b8 0a 00 00 00       	mov    $0xa,%eax
  800279:	e8 3a fe ff ff       	call   8000b8 <syscall>
}
  80027e:	c9                   	leave  
  80027f:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028d:	00 
  80028e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800295:	00 
  800296:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80029d:	00 
  80029e:	8b 45 0c             	mov    0xc(%ebp),%eax
  8002a1:	89 04 24             	mov    %eax,(%esp)
  8002a4:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8002a7:	ba 01 00 00 00       	mov    $0x1,%edx
  8002ac:	b8 09 00 00 00       	mov    $0x9,%eax
  8002b1:	e8 02 fe ff ff       	call   8000b8 <syscall>
}
  8002b6:	c9                   	leave  
  8002b7:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c5:	00 
  8002c6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002cd:	00 
  ...
  8002df:	ba 01 00 00 00       	mov    $0x1,%edx
  8002e4:	b8 07 00 00 00       	mov    $0x7,%eax
  8002e9:	e8 ca fd ff ff       	call   8000b8 <syscall>
}
  8002ee:	c9                   	leave  
  8002ef:	c3                   	ret    

008002f0 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800301:	0b 45 14             	or     0x14(%ebp),%eax
  ...
  800318:	ba 01 00 00 00       	mov    $0x1,%edx
  80031d:	b8 06 00 00 00       	mov    $0x6,%eax
  800322:	e8 91 fd ff ff       	call   8000b8 <syscall>
}
  800327:	c9                   	leave  
  800328:	c3                   	ret    

00800329 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800336:	00 
  800337:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80033e:	00 
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8003c7:	b8 04 00 00 00       	mov    $0x4,%eax
  8003cc:	e8 e7 fc ff ff       	call   8000b8 <syscall>
}
  8003d1:	c9                   	leave  
  8003d2:	c3                   	ret    

008003d3 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003e0:	00 
  8003e1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003e8:	00 
  8003e9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003f0:	00 
  8003f1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003f8:	b9 00 00 00 00       	mov    $0x0,%ecx
  8003fd:	ba 00 00 00 00       	mov    $0x0,%edx
  800402:	b8 02 00 00 00       	mov    $0x2,%eax
  800407:	e8 ac fc ff ff       	call   8000b8 <syscall>
}
  80040c:	c9                   	leave  
  80040d:	c3                   	ret    

0080040e <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  80041b:	00 
  80041c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800423:	00 
  800424:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80042b:	00 
  80042c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800433:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800436:	ba 01 00 00 00       	mov    $0x1,%edx
  80043b:	b8 03 00 00 00       	mov    $0x3,%eax
...
sys_cgetc(void)
{
  ...
  800454:	00 
  800455:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80045c:	00 
  80045d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800464:	00 
  800465:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80046c:	b9 00 00 00 00       	mov    $0x0,%ecx
  800471:	ba 00 00 00 00       	mov    $0x0,%edx
  800476:	b8 01 00 00 00       	mov    $0x1,%eax
  80047b:	e8 38 fc ff ff       	call   8000b8 <syscall>
}
  800480:	c9                   	leave  
  800481:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  80048f:	00 
  800490:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800497:	00 
  800498:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80049f:	00 
  ...
  8004b3:	e8 00 fc ff ff       	call   8000b8 <syscall>
}
  8004b8:	c9                   	leave  
  8004b9:	c3                   	ret    
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800602:	be 58 23 80 00       	mov    $0x802358,%esi
  ...
  800621:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800706:	c7 04 24 fc 22 80 00 	movl   $0x8022fc,(%esp)
  ...
  800766:	e8 66 fe ff ff       	call   8005d1 <dev_lookup>
{
  ...
  800788:	c7 04 24 1d 23 80 00 	movl   $0x80231d,(%esp)
  ...
  8007ef:	e8 dd fd ff ff       	call   8005d1 <dev_lookup>
{
  ...
  800816:	c7 04 24 3a 23 80 00 	movl   $0x80233a,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  80091b:	e8 98 f9 ff ff       	call   8002b8 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800a6c:	e8 7f f8 ff ff       	call   8002f0 <sys_page_map>
  ...
  800aa7:	e8 44 f8 ff ff       	call   8002f0 <sys_page_map>
...
fsipc(unsigned type, void *dstva)
{
  ...
  800b2e:	e8 b1 13 00 00       	call   801ee4 <ipc_send>
  ...
  800b46:	e8 04 14 00 00       	call   801f4f <ipc_recv>
}
...
out:
  ...
  800d7d:	c7 44 24 0c 64 23 80 	movl   $0x802364,0xc(%esp)
  800d84:	00 
  800d85:	c7 44 24 08 79 23 80 	movl   $0x802379,0x8(%esp)
  800d8c:	00 
  800d8d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800d94:	00 
  800d95:	c7 04 24 8e 23 80 00 	movl   $0x80238e,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800db6:	c7 44 24 04 99 23 80 	movl   $0x802399,0x4(%esp)
  800dbd:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  800ddd:	e8 fa 11 00 00       	call   801fdc <pageref>
...
alloc_sockfd(int sockid)
{
  ...
  800e88:	e8 9c f4 ff ff       	call   800329 <sys_page_alloc>
...
nsipc(unsigned type)
{
  ...
  80103f:	e8 a0 0e 00 00       	call   801ee4 <ipc_send>
  ...
  80105b:	e8 ef 0e 00 00       	call   801f4f <ipc_recv>
}
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801108:	c7 44 24 0c a5 23 80 	movl   $0x8023a5,0xc(%esp)
  80110f:	00 
  801110:	c7 44 24 08 79 23 80 	movl   $0x802379,0x8(%esp)
  801117:	00 
  801118:	c7 44 24 04 6c 00 00 	movl   $0x6c,0x4(%esp)
  80111f:	00 
  801120:	c7 04 24 b1 23 80 00 	movl   $0x8023b1,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80119d:	c7 44 24 0c bd 23 80 	movl   $0x8023bd,0xc(%esp)
  8011a4:	00 
  8011a5:	c7 44 24 08 79 23 80 	movl   $0x802379,0x8(%esp)
  8011ac:	00 
  8011ad:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  8011b4:	00 
  8011b5:	c7 04 24 b1 23 80 00 	movl   $0x8023b1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8012c5:	e8 09 f1 ff ff       	call   8003d3 <sys_getenvid>
  ...
  8012e0:	c7 04 24 d4 23 80 00 	movl   $0x8023d4,(%esp)
  ...
  8012f6:	e8 11 00 00 00       	call   80130c <vcprintf>
	cprintf("\n");
  8012fb:	c7 04 24 54 23 80 00 	movl   $0x802354,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801360:	e8 1d f1 ff ff       	call   800482 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  8013b4:	e8 c9 f0 ff ff       	call   800482 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80144d:	e8 ce 0b 00 00       	call   802020 <__udivdi3>
  ...
  8014a8:	e8 a3 0c 00 00       	call   802150 <__umoddi3>
  8014ad:	89 74 24 04          	mov    %esi,0x4(%esp)
  8014b1:	0f be 80 f7 23 80 00 	movsbl 0x8023f7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801677:	c7 44 24 08 08 24 80 	movl   $0x802408,0x8(%esp)
  80167e:	00 
  ...
  801697:	c7 44 24 08 8b 23 80 	movl   $0x80238b,0x8(%esp)
  80169e:	00 
  ...
  8016d1:	b8 11 24 80 00       	mov    $0x802411,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  801915:	c7 44 24 0c 2c 25 80 	movl   $0x80252c,0xc(%esp)
  80191c:	00 
  80191d:	c7 44 24 08 8b 23 80 	movl   $0x80238b,0x8(%esp)
  801924:	00 
  ...
  801943:	c7 44 24 0c 64 25 80 	movl   $0x802564,0xc(%esp)
  80194a:	00 
  80194b:	c7 44 24 08 8b 23 80 	movl   $0x80238b,0x8(%esp)
  801952:	00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f0b:	c7 44 24 08 80 27 80 	movl   $0x802780,0x8(%esp)
  801f12:	00 
  801f13:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  801f1a:	00 
  801f1b:	c7 04 24 9e 27 80 00 	movl   $0x80279e,(%esp)
  801f22:	e8 8d f3 ff ff       	call   8012b4 <_panic>
{
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  801f39:	e8 9c e2 ff ff       	call   8001da <sys_ipc_try_send>
  ...
  801f40:	75 c0                	jne    801f02 <ipc_send+0x1e>
	...
	sys_yield();
  801f42:	e8 19 e4 ff ff       	call   800360 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f74:	e8 28 e2 ff ff       	call   8001a1 <sys_ipc_recv>
  ...
  801f87:	c7 04 24 a8 27 80 00 	movl   $0x8027a8,(%esp)
  801f8e:	e8 da f3 ff ff       	call   80136d <cprintf>

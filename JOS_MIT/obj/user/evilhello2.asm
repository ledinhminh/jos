...
008001bc <.after_sysenter_label>:
  ...
  8001d7:	c7 44 24 08 6a 23 80 	movl   $0x80236a,0x8(%esp)
  8001de:	00 
  8001df:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  8001e6:	00 
  8001e7:	c7 04 24 87 23 80 00 	movl   $0x802387,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8006d2:	be 14 24 80 00       	mov    $0x802414,%esi
  ...
  8006f1:	c7 04 24 98 23 80 00 	movl   $0x802398,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8007d6:	c7 04 24 b8 23 80 00 	movl   $0x8023b8,(%esp)
  ...
  800836:	e8 66 fe ff ff       	call   8006a1 <dev_lookup>
{
  ...
  800858:	c7 04 24 d9 23 80 00 	movl   $0x8023d9,(%esp)
  ...
  8008bf:	e8 dd fd ff ff       	call   8006a1 <dev_lookup>
{
  ...
  8008e6:	c7 04 24 f6 23 80 00 	movl   $0x8023f6,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800bfe:	e8 b1 13 00 00       	call   801fb4 <ipc_send>
  ...
  800c16:	e8 04 14 00 00       	call   80201f <ipc_recv>
}
...
out:
  ...
  800e4d:	c7 44 24 0c 20 24 80 	movl   $0x802420,0xc(%esp)
  800e54:	00 
  800e55:	c7 44 24 08 35 24 80 	movl   $0x802435,0x8(%esp)
  800e5c:	00 
  800e5d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800e64:	00 
  800e65:	c7 04 24 4a 24 80 00 	movl   $0x80244a,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e86:	c7 44 24 04 55 24 80 	movl   $0x802455,0x4(%esp)
  800e8d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  800ead:	e8 fa 11 00 00       	call   8020ac <pageref>
...
nsipc(unsigned type)
{
  ...
  80110f:	e8 a0 0e 00 00       	call   801fb4 <ipc_send>
  ...
  80112b:	e8 ef 0e 00 00       	call   80201f <ipc_recv>
}
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011d8:	c7 44 24 0c 61 24 80 	movl   $0x802461,0xc(%esp)
  8011df:	00 
  8011e0:	c7 44 24 08 35 24 80 	movl   $0x802435,0x8(%esp)
  8011e7:	00 
  8011e8:	c7 44 24 04 6c 00 00 	movl   $0x6c,0x4(%esp)
  8011ef:	00 
  8011f0:	c7 04 24 6d 24 80 00 	movl   $0x80246d,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80126d:	c7 44 24 0c 79 24 80 	movl   $0x802479,0xc(%esp)
  801274:	00 
  801275:	c7 44 24 08 35 24 80 	movl   $0x802435,0x8(%esp)
  80127c:	00 
  80127d:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  801284:	00 
  801285:	c7 04 24 6d 24 80 00 	movl   $0x80246d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8013b0:	c7 04 24 90 24 80 00 	movl   $0x802490,(%esp)
  ...
  8013c6:	e8 11 00 00 00       	call   8013dc <vcprintf>
	cprintf("\n");
  8013cb:	c7 04 24 10 24 80 00 	movl   $0x802410,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80151d:	e8 ce 0b 00 00       	call   8020f0 <__udivdi3>
  ...
  801578:	e8 a3 0c 00 00       	call   802220 <__umoddi3>
  80157d:	89 74 24 04          	mov    %esi,0x4(%esp)
  801581:	0f be 80 b3 24 80 00 	movsbl 0x8024b3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801665:	ff 24 95 a0 26 80 00 	jmp    *0x8026a0(,%edx,4)
  ...
  801767:	c7 44 24 08 47 24 80 	movl   $0x802447,0x8(%esp)
  80176e:	00 
  ...
  8017a1:	b8 cd 24 80 00       	mov    $0x8024cd,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  8019e5:	c7 44 24 0c e8 25 80 	movl   $0x8025e8,0xc(%esp)
  8019ec:	00 
  8019ed:	c7 44 24 08 47 24 80 	movl   $0x802447,0x8(%esp)
  8019f4:	00 
  ...
  801a13:	c7 44 24 0c 20 26 80 	movl   $0x802620,0xc(%esp)
  801a1a:	00 
  801a1b:	c7 44 24 08 47 24 80 	movl   $0x802447,0x8(%esp)
  801a22:	00 
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801fdb:	c7 44 24 08 40 28 80 	movl   $0x802840,0x8(%esp)
  801fe2:	00 
  801fe3:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
  801fea:	00 
  801feb:	c7 04 24 5e 28 80 00 	movl   $0x80285e,(%esp)
  801ff2:	e8 8d f3 ff ff       	call   801384 <_panic>
{
	// LAB 4: Your code here.
	int r;
	if(!pg)
  ...
  802009:	e8 a0 e2 ff ff       	call   8002ae <sys_ipc_try_send>
  ...
  802010:	75 c0                	jne    801fd2 <ipc_send+0x1e>
	...
	sys_yield();
  802012:	e8 1d e4 ff ff       	call   800434 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802044:	e8 2c e2 ff ff       	call   800275 <sys_ipc_recv>
  ...
  802057:	c7 04 24 68 28 80 00 	movl   $0x802868,(%esp)
  80205e:	e8 da f3 ff ff       	call   80143d <cprintf>
  ...
  80208b:	a1 20 60 80 00       	mov    0x806020,%eax
  802090:	8b 40 78             	mov    0x78(%eax),%eax
  802093:	89 07                	mov    %eax,(%edi)
	//panic("ipc_recv not implemented");
	return thisenv->env_ipc_value;
  802095:	a1 20 60 80 00       	mov    0x806020,%eax

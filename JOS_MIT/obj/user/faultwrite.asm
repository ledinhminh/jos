...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 fd 02 00 00       	call   800358 <sys_getenvid>
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 8a 08 00 00       	call   800929 <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 e8 02 00 00       	call   800393 <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
008000e0 <.after_sysenter_label>:
  ...
  8000fb:	c7 44 24 08 ea 1c 80 	movl   $0x801cea,0x8(%esp)
  800102:	00 
  800103:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  80010a:	00 
  80010b:	c7 04 24 07 1d 80 00 	movl   $0x801d07,(%esp)
  800112:	e8 19 0c 00 00       	call   800d30 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80014e:	ba 01 00 00 00       	mov    $0x1,%edx
  800153:	b8 0e 00 00 00       	mov    $0xe,%eax
  800158:	e8 53 ff ff ff       	call   8000b0 <syscall>
}
  80015d:	c9                   	leave  
  80015e:	c3                   	ret    

0080015f <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800162:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_ipc_try_send, 0, envid, value, (uint32_t) srcva, perm, 0);
  800165:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80016c:	00 
  80016d:	8b 45 14             	mov    0x14(%ebp),%eax
  ...
  80018e:	e8 1d ff ff ff       	call   8000b0 <syscall>
}
  800193:	c9                   	leave  
  800194:	c3                   	ret    

00800195 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001c6:	e8 e5 fe ff ff       	call   8000b0 <syscall>
}
  8001cb:	c9                   	leave  
  8001cc:	c3                   	ret    

008001cd <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8001f4:	ba 01 00 00 00       	mov    $0x1,%edx
  8001f9:	b8 0a 00 00 00       	mov    $0xa,%eax
  8001fe:	e8 ad fe ff ff       	call   8000b0 <syscall>
}
  800203:	c9                   	leave  
  800204:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800212:	00 
  800213:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80021a:	00 
  ...
  800231:	b8 09 00 00 00       	mov    $0x9,%eax
  800236:	e8 75 fe ff ff       	call   8000b0 <syscall>
}
  80023b:	c9                   	leave  
  80023c:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024a:	00 
  80024b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800252:	00 
  800253:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80025a:	00 
  ...
  800269:	b8 07 00 00 00       	mov    $0x7,%eax
  80026e:	e8 3d fe ff ff       	call   8000b0 <syscall>
}
  800273:	c9                   	leave  
  800274:	c3                   	ret    

00800275 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800282:	00 
  800283:	8b 45 18             	mov    0x18(%ebp),%eax
  800286:	0b 45 14             	or     0x14(%ebp),%eax
  ...
  8002a2:	b8 06 00 00 00       	mov    $0x6,%eax
  8002a7:	e8 04 fe ff ff       	call   8000b0 <syscall>
}
  8002ac:	c9                   	leave  
  8002ad:	c3                   	ret    

008002ae <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002bb:	00 
  8002bc:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002c3:	00 
  ...
  8002d9:	b8 05 00 00 00       	mov    $0x5,%eax
  8002de:	e8 cd fd ff ff       	call   8000b0 <syscall>
}
  8002e3:	c9                   	leave  
  8002e4:	c3                   	ret    
...
sys_yield(void)
{
  ...
  8002f2:	00 
  8002f3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002fa:	00 
  8002fb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800302:	00 
  800303:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80030a:	b9 00 00 00 00       	mov    $0x0,%ecx
  80030f:	ba 00 00 00 00       	mov    $0x0,%edx
  800314:	b8 0c 00 00 00       	mov    $0xc,%eax
  800319:	e8 92 fd ff ff       	call   8000b0 <syscall>
}
  80031e:	c9                   	leave  
  80031f:	c3                   	ret    

00800320 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80032d:	00 
  80032e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800335:	00 
  ...
  80034c:	b8 04 00 00 00       	mov    $0x4,%eax
  800351:	e8 5a fd ff ff       	call   8000b0 <syscall>
}
  800356:	c9                   	leave  
  800357:	c3                   	ret    

00800358 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  800387:	b8 02 00 00 00       	mov    $0x2,%eax
  80038c:	e8 1f fd ff ff       	call   8000b0 <syscall>
}
  800391:	c9                   	leave  
  800392:	c3                   	ret    

00800393 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003b0:	00 
  8003b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003b8:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8003bb:	ba 01 00 00 00       	mov    $0x1,%edx
  8003c0:	b8 03 00 00 00       	mov    $0x3,%eax
  8003c5:	e8 e6 fc ff ff       	call   8000b0 <syscall>
}
  8003ca:	c9                   	leave  
  8003cb:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8003cf:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
  8003d2:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8003d9:	00 
  8003da:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003e1:	00 
  8003e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003e9:	00 
  8003ea:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003f1:	b9 00 00 00 00       	mov    $0x0,%ecx
  8003f6:	ba 00 00 00 00       	mov    $0x0,%edx
  8003fb:	b8 01 00 00 00       	mov    $0x1,%eax
  800400:	e8 ab fc ff ff       	call   8000b0 <syscall>
}
  800405:	c9                   	leave  
  800406:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800414:	00 
  800415:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80041c:	00 
  80041d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800424:	00 
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  80089b:	e8 9d f9 ff ff       	call   80023d <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8009ec:	e8 84 f8 ff ff       	call   800275 <sys_page_map>
  ...
  800a27:	e8 49 f8 ff ff       	call   800275 <sys_page_map>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800d41:	e8 12 f6 ff ff       	call   800358 <sys_getenvid>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800ddc:	e8 26 f6 ff ff       	call   800407 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800e30:	e8 d2 f5 ff ff       	call   800407 <sys_cputs>
		b->idx = 0;
  ...
  8019a6:	e8 85 f3 ff ff       	call   800d30 <_panic>
{
  ...
  8019bd:	e8 9d e7 ff ff       	call   80015f <sys_ipc_try_send>
  ...
  8019c4:	75 bc                	jne    801982 <ipc_send+0x1e>
	...
	sys_yield();
  8019c6:	e8 1a e9 ff ff       	call   8002e5 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019f8:	e8 29 e7 ff ff       	call   800126 <sys_ipc_recv>

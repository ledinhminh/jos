...
umain(int argc, char **argv)
{
  ...
  800049:	e8 c5 03 00 00       	call   800413 <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800062:	e8 fd 02 00 00       	call   800364 <sys_getenvid>
...
exit(void)
{
  ...
  8000a3:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a6:	e8 8e 08 00 00       	call   800939 <close_all>
	sys_env_destroy(0);
  8000ab:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b2:	e8 e8 02 00 00       	call   80039f <sys_env_destroy>
}
  8000b7:	c9                   	leave  
  8000b8:	c3                   	ret    
...
008000ec <.after_sysenter_label>:
  ...
  800107:	c7 44 24 08 0a 1d 80 	movl   $0x801d0a,0x8(%esp)
  80010e:	00 
  80010f:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800116:	00 
  800117:	c7 04 24 27 1d 80 00 	movl   $0x801d27,(%esp)
  80011e:	e8 1d 0c 00 00       	call   800d40 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80015f:	b8 0e 00 00 00       	mov    $0xe,%eax
  800164:	e8 53 ff ff ff       	call   8000bc <syscall>
}
  800169:	c9                   	leave  
  80016a:	c3                   	ret    
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80016e:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_ipc_try_send, 0, envid, value, (uint32_t) srcva, perm, 0);
  800171:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800178:	00 
  800179:	8b 45 14             	mov    0x14(%ebp),%eax
  80017c:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  800195:	b8 0d 00 00 00       	mov    $0xd,%eax
  80019a:	e8 1d ff ff ff       	call   8000bc <syscall>
}
  80019f:	c9                   	leave  
  8001a0:	c3                   	ret    

008001a1 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001c8:	ba 01 00 00 00       	mov    $0x1,%edx
  8001cd:	b8 0b 00 00 00       	mov    $0xb,%eax
  8001d2:	e8 e5 fe ff ff       	call   8000bc <syscall>
}
  8001d7:	c9                   	leave  
  8001d8:	c3                   	ret    

008001d9 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8001dc:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_env_set_trapframe, 1, envid, (uint32_t) tf, 0, 0, 0);
  8001df:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8001e6:	00 
  8001e7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8001ee:	00 
  8001ef:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001f6:	00 
  ...
  800205:	b8 0a 00 00 00       	mov    $0xa,%eax
  80020a:	e8 ad fe ff ff       	call   8000bc <syscall>
}
  80020f:	c9                   	leave  
  800210:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80021e:	00 
  80021f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800226:	00 
  800227:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80022e:	00 
  ...
  800242:	e8 75 fe ff ff       	call   8000bc <syscall>
}
  800247:	c9                   	leave  
  800248:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800256:	00 
  800257:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80025e:	00 
  80025f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800266:	00 
  ...
  800275:	b8 07 00 00 00       	mov    $0x7,%eax
  80027a:	e8 3d fe ff ff       	call   8000bc <syscall>
}
  80027f:	c9                   	leave  
  800280:	c3                   	ret    

00800281 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800292:	0b 45 14             	or     0x14(%ebp),%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002c7:	00 
  8002c8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8002cf:	00 
  ...
  8002e5:	b8 05 00 00 00       	mov    $0x5,%eax
  8002ea:	e8 cd fd ff ff       	call   8000bc <syscall>
}
  8002ef:	c9                   	leave  
  8002f0:	c3                   	ret    
...
sys_yield(void)
{
  ...
  8002fe:	00 
  8002ff:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800306:	00 
  ...
  800325:	e8 92 fd ff ff       	call   8000bc <syscall>
}
  80032a:	c9                   	leave  
  80032b:	c3                   	ret    

0080032c <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800339:	00 
  80033a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800341:	00 
  800342:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800349:	00 
  ...
  800358:	b8 04 00 00 00       	mov    $0x4,%eax
  80035d:	e8 5a fd ff ff       	call   8000bc <syscall>
}
  800362:	c9                   	leave  
  800363:	c3                   	ret    

00800364 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  800393:	b8 02 00 00 00       	mov    $0x2,%eax
  800398:	e8 1f fd ff ff       	call   8000bc <syscall>
}
  80039d:	c9                   	leave  
  80039e:	c3                   	ret    

0080039f <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003c7:	ba 01 00 00 00       	mov    $0x1,%edx
  8003cc:	b8 03 00 00 00       	mov    $0x3,%eax
  8003d1:	e8 e6 fc ff ff       	call   8000bc <syscall>
}
  8003d6:	c9                   	leave  
  8003d7:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8003db:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
  8003de:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8003e5:	00 
  8003e6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8003ed:	00 
  8003ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8003f5:	00 
  8003f6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8003fd:	b9 00 00 00 00       	mov    $0x0,%ecx
  800402:	ba 00 00 00 00       	mov    $0x0,%edx
  800407:	b8 01 00 00 00       	mov    $0x1,%eax
  80040c:	e8 ab fc ff ff       	call   8000bc <syscall>
}
  800411:	c9                   	leave  
  800412:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800416:	83 ec 18             	sub    $0x18,%esp
	syscall(SYS_cputs, 0, (uint32_t)s, len, 0, 0, 0);
  800419:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800420:	00 
  800421:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800428:	00 
  800429:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800430:	00 
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800592:	be b4 1d 80 00       	mov    $0x801db4,%esi
  ...
  8005b1:	c7 04 24 38 1d 80 00 	movl   $0x801d38,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800696:	c7 04 24 58 1d 80 00 	movl   $0x801d58,(%esp)
  ...
  8006f6:	e8 66 fe ff ff       	call   800561 <dev_lookup>
{
  ...
  800718:	c7 04 24 79 1d 80 00 	movl   $0x801d79,(%esp)
  ...
  80077f:	e8 dd fd ff ff       	call   800561 <dev_lookup>
{
  ...
  8007a6:	c7 04 24 96 1d 80 00 	movl   $0x801d96,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8008ab:	e8 99 f9 ff ff       	call   800249 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8009fc:	e8 80 f8 ff ff       	call   800281 <sys_page_map>
  ...
  800a37:	e8 45 f8 ff ff       	call   800281 <sys_page_map>
...
out:
  ...
  800d0d:	c7 44 24 0c bc 1d 80 	movl   $0x801dbc,0xc(%esp)
  800d14:	00 
  800d15:	c7 44 24 08 d1 1d 80 	movl   $0x801dd1,0x8(%esp)
  800d1c:	00 
  800d1d:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  800d24:	00 
  800d25:	c7 04 24 e6 1d 80 00 	movl   $0x801de6,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800d51:	e8 0e f6 ff ff       	call   800364 <sys_getenvid>
  ...
  800d6c:	c7 04 24 f4 1d 80 00 	movl   $0x801df4,(%esp)
  ...
  800d82:	e8 11 00 00 00       	call   800d98 <vcprintf>
	cprintf("\n");
  800d87:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800dec:	e8 22 f6 ff ff       	call   800413 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800e40:	e8 ce f5 ff ff       	call   800413 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800f41:	0f be 80 17 1e 80 00 	movsbl 0x801e17(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801107:	c7 44 24 08 28 1e 80 	movl   $0x801e28,0x8(%esp)
  80110e:	00 
  ...
  801127:	c7 44 24 08 e3 1d 80 	movl   $0x801de3,0x8(%esp)
  80112e:	00 
  ...
  801161:	b8 31 1e 80 00       	mov    $0x801e31,%eax
...
getint(va_list *ap, int lflag)
{
  ...
  8013a5:	c7 44 24 0c 4c 1f 80 	movl   $0x801f4c,0xc(%esp)
  8013ac:	00 
  8013ad:	c7 44 24 08 e3 1d 80 	movl   $0x801de3,0x8(%esp)
  8013b4:	00 
  ...
  8013d3:	c7 44 24 0c 84 1f 80 	movl   $0x801f84,0xc(%esp)
  8013da:	00 
  8013db:	c7 44 24 08 e3 1d 80 	movl   $0x801de3,0x8(%esp)
  8013e2:	00 
  ...
  8019b6:	e8 85 f3 ff ff       	call   800d40 <_panic>
{
  ...
  8019cd:	e8 99 e7 ff ff       	call   80016b <sys_ipc_try_send>
  ...
  8019d4:	75 bc                	jne    801992 <ipc_send+0x1e>
	...
	sys_yield();
  8019d6:	e8 16 e9 ff ff       	call   8002f1 <sys_yield>
}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a08:	e8 25 e7 ff ff       	call   800132 <sys_ipc_recv>
